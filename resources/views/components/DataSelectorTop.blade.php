<div class="pt-10 bg-gray-900 sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
    <div class="mx-auto max-w-7xl lg:px-8">
        <div class="grid grid-cols-2 lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div class="hidden mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative md:block">
                <div class="max-w-md px-4 mx-auto sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                    <!-- Illustration taken from Lucid Illustrations: https://lucid.pixsellz.io/ -->
                    <img class="w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="{{url('/images/bg.jpg')}}" alt="">
                </div>
            </div>
        </div>
    </div>
