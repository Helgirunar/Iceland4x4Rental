  ...
  <div class="px-4 py-16 mx-auto max-w-7xl sm:py-24 sm:px-6 lg:px-8">
    <div class="relative bg-white rounded-lg shadow-xl">
      ...
      <div class="grid grid-cols-1">
        ...
        <!-- Contact form -->
        <p class="mt-2 text-3xl font-extrabold tracking-tight text-center text-gray-900 sm:text-4xl">{{ __('contact title') }}</p>
        <div class="px-6 py-10 sm:px-10 lg:col-span-1 xl:p-12">
          <h3 class="text-lg font-medium text-gray-900">{{ __('contact description') }}</h3>
          <form action="#" method="POST" class="grid grid-cols-1 mt-6 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            <div>
              <label for="first-name" class="block text-sm font-medium text-gray-900">{{ __('contact name') }}</label>
              <div class="mt-1">
            ...
            <div>
              <label for="email" class="block text-sm font-medium text-gray-900">{{ __('contact email') }}</label>
              <div class="mt-1">
            ...
            <div class="sm:col-span-2">
              <div class="flex justify-between">
                <label for="message" class="block text-sm font-medium text-gray-900">{{ __('contact message') }}</label>
                <span id="message-max" class="text-sm text-gray-500">{{ __('contact max') }}</span>
              </div>
              <div class="mt-1">
            ...
            <div class="sm:col-span-2 sm:flex sm:justify-end">
              <button type="submit" class="inline-flex items-center justify-center w-full px-6 py-3 mt-2 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto">{{ __('contact submit') }}</button>
            </div>
          </form>
        </div>
      </div>
